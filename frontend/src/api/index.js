...
export const scheduleApi = {
  ...
  addItem(id, data) {
    return request.post(`/schedules/${id}/items`, data)
  },
  
  updateItem(id, itemId, data) {
    return request.put(`/schedules/${id}/items/${itemId}`, data)
  },
  
  deleteItem(id, itemId) {
    return request.delete(`/schedules/${id}/items/${itemId}`)
  },
  
  moveItem(id, itemId, data) {
    return request.put(`/schedules/${id}/items/${itemId}/move`, data)
  },
  
  checkConflict(id, params) {
    return request.get(`/schedules/${id}/check-conflict`, { params })
  }
}
